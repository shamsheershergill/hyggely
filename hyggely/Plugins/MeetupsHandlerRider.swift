//
//  MeetupsHandlerViewController.swift
//  hyggely
//
...
//RIDER
protocol RiderController: class {
    func canCallUber(delegateCalled: Bool);
    func driverAcceptedRequest(requestAccepted: Bool, driverName: String);
    func updateDriversLocation(lat: Double, long: Double);
}

class MeetupsHandlerRider {
    private static let _instance = MeetupsHandlerRider();
    
    weak var delegate: RiderController?;
    
    var rider = "";
    var driver = "";
    var rider_id = "";
    
    static var Instance: MeetupsHandlerRider {
        return _instance;
    }
