...
protocol DriverController: class {
...
class MeetupsHandlerDriver {
    private static let _instance = MeetupsHandlerDriver();
    
    weak var delegate: DriverController?;
    
    var rider = "";
    var driver = "";
    var driver_id = "";
    
    static var Instance: MeetupsHandlerDriver {
        return _instance;
    }
